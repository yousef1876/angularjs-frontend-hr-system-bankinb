...
public class TransactionNotExistException extends RuntimeException {
    ...
    public TransactionNotExistException(Throwable cause) {
        super(cause);
    }

    public TransactionNotExistException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public TransactionNotExistException() {
        super("Transaction Information Not Exist");
    }
