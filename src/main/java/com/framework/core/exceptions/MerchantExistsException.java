...
public class MerchantExistsException extends RuntimeException {
    ...
    public MerchantExistsException(String message, Throwable cause) {
        super(message, cause);
    }

    public MerchantExistsException(String message) {
        super(message);
    }

    public MerchantExistsException() {

        super("Merchant Information Exist");
    }

    @ExceptionHandler(MerchantExistsException.class)
