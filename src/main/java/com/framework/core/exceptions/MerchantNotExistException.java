...
public class MerchantNotExistException extends RuntimeException {
    ...
    public MerchantNotExistException(Throwable cause) {
        super(cause);
    }

    public MerchantNotExistException(String message, Throwable cause) {
        super(message, cause);
    }

    public MerchantNotExistException(String message) {
        super(message);
    }

    public MerchantNotExistException() {

        super("Merchant Information Not Exist");
    }


    @ExceptionHandler(MerchantNotExistException.class)
