...
@ControllerAdvice
public class BillExistsException extends RuntimeException {

    public BillExistsException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public BillExistsException() {
        super("Bill Information Exist");
    }


    @ExceptionHandler(BillExistsException.class)
