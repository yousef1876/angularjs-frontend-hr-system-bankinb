package com.framework.core.springmvc.api.post;

import com.framework.core.springmvc.Constants;
import com.framework.core.springmvc.domain.Post;
import com.framework.core.springmvc.exception.InvalidRequestException;
import com.framework.core.springmvc.model.CommentDetails;
import com.framework.core.springmvc.model.CommentForm;
...
public class PostController {
    ...
    public ResponseEntity<Page<PostDetails>> getAllPosts(
        ...
        Page<PostDetails> posts = null ; /*blogService.searchPostsByCriteria(keyword, status, page);*/
