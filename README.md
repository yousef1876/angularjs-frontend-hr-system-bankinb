angularjs/ngapp --> frontend application for repo "https://github.com/yousef1876/Ecommerce-Banking-IngenicoConnectAPI.git" is not complete yet but its contain many good 
feathers:
